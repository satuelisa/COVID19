...
set arrow 7 from "2021/07/09", graph 0 to "2021/07/09", graph 1 nohead lw 5 lc rgb '#990000' # nuevas restricciones
...
set title 'San Nicol\341s de los Garza, Nuevo Le\363n, M\351xico: COVID-19: promedio semanal de nuevos confirmados (con tendencia lineal), dibujado cada d\355a' font ",18"
set yrange [0:y5*1.1]
set ytics 0, 20
set ylabel 'Casos'
...
set title 'San Nicol\341s de los Garza, Nuevo Le\363n, M\351xico: COVID-19: acumulado quincenal (estimado de casos activos), dibujado cada tres d\355as' font ",18"
set yrange [0:y4*1.1]
set ytics 0, 200
